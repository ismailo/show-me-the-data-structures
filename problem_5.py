...
if __name__ == "__main__":
    ...
    # Test Case 2
    bc2 = Blockchain()
    assert len(bc2.chain) == 1                   # genesis only
    assert bc2.chain[0].previous_hash == "0"

    # Test Case 3
    bc3 = Blockchain()
    bc3.add_block("")                            # empty data block
    assert bc3.chain[-1].data == ""
    assert bc3.chain[-1].previous_hash == bc3.chain[-2].hash